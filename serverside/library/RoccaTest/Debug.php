...
class RoccaTest_Debug extends Rocca_UnitTest
{
	...
	public function run() {
		...
		$bRes = strpos( $sOut, "Rocca/serverside/library/RoccaTest/Debug.php: Line 13: RoccaTest_Debug::run(): Unit testing...\n" );
		...
		$bRes2 = strpos( $sOut2, "Rocca/serverside/library/RoccaTest/Debug.php: Line 21: RoccaTest_Debug::run(): More unit testing...\n" );
